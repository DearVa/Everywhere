...
public class VisualContextPlugin : BuiltInChatPlugin
{
    ...
    private Task<FileAttachment> CaptureVisualElementByIdAsync(
    ...
    private async Task<FileAttachment> CaptureVisualElementAsync(IVisualElement visualElement, CancellationToken cancellationToken)
    {
